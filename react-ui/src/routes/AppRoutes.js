...
export default function AppRoutes() {
  return (
    <Switch>
      ...
      <CustomRoute isPrivate={true} exact path='/workflows/:name' component={WorkflowContainer} fullWidth={true} />
      ...
      />
      <CustomRoute isPrivate={true} exact path='/settings' component={Settings} />
